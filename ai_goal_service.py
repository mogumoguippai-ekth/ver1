...
### 長期目標（3年後）
[社会貢献や身近な人との関わりを重視した具体的な長期目標の内容を100文字以内で記載してください]
...
注意事項：
- ボランティア活動、コミュニティ参加、近所の人との交流、家族との時間などを含めてください
- 具体的で測定可能な目標にしてください
- 日本語で回答してください、長期目標文末と短期目標内容文末に文字数表示は不要です
""",
            # パターン3: 学習・スキル向上重視
...
### 長期目標（3年後）
[学習とスキル向上を重視した具体的な長期目標の内容を100文字以内で記載してください]
...
以下のユーザー情報を基に、50代以降の人の3年後の長期目標とそれを達成するための3つの短期目標を提案してください。
ユーザーの強みを活かし、不安や課題を考慮した実現可能な目標を提案してください。
特に経済的安定と投資や貯蓄に焦点を当てた目標を提案してください。
...
### 長期目標（3年後）
[充実したセカンドライフのための長期目標の内容を100文字以内で記載してください]

### 短期目標1
**テーマ**: [経済環境や投資・貯蓄に関する目標テーマ]
**内容**: [具体的な目標内容を100文字以内で記載してください]
**理由**: [なぜこの目標が重要なのか]

### 短期目標2
**テーマ**: [社会課題解決のための経済的貢献に関する目標テーマ]
**内容**: [具体的な目標内容を100文字以内で記載してください]
**理由**: [なぜこの目標が重要なのか]
...
### 長期目標（3年後）
[趣味と創造性を重視した具体的な長期目標の内容を100文字以内で記載してください]
